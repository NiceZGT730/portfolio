...
> = {
  'imdb-api': {
    ...
    description:
      'A personal project to integrate IMDb API with Angular, allowing users to search for movies and add their favorites using LocalStorage.',
    frameworks: 'Angular, LocalStorage',
    role:
      'Fullstack developer responsible for both backend integration with IMDb API and frontend implementation using Angular. Built the favorite management system with LocalStorage to store user preferences.',
    date: 'April 2025',
    images: ['/images/imdb/p1.jpg', '/images/imdb/p2.jpg', '/images/imdb/p3.jpg', '/images/imdb/p4.jpg', '/images/imdb/p5.jpg'],
  ...
  'crud-recipe': {
    ...
    date: 'October 2024',
    images: ['/images/Food/p1.jpg', '/images/Food/p2.jpg', '/images/Food/p3.jpg'],
    github: 'https://github.com/ChinatipJ/Project',
  },
  'maintenance-management': {
    title: 'Maintenance Request Management System',
    description:
      'A backend-driven web platform for submitting repair requests and managing admin task assignments. Developed solo, focusing on backend logic and system architecture.',
    frameworks: 'HTML, CSS, Bootstrap5, MySQL',
    ...
    date: 'October 2024',
    images: [
      '/images/954417/p1.jpg',
      '/images/954417/p2.jpg',
      '/images/954417/p3.jpg',
      '/images/954417/p4.jpg',
      '/images/954417/p5.jpg',
      '/images/954417/p6.jpg',
      '/images/954417/p7.jpg',
      '/images/954417/p8.jpg',
      '/images/954417/p9.jpg',
    ],
    github: 'https://github.com/NiceZGT730/954417',
  },
  'stock-management': {
  ...
  'electricity-bill': {
    ...
    date: 'October 2022',
    images: ['/images/electricity1.jpg', '/images/electricity2.jpg'],
  },
  'server-admin': {
    ...
    date: '2016 - 2021',
    images: ['/images/server/p1.jpg', '/images/server/p2.png', '/images/server/p3.jpg', '/images/server/p4.png'],
  },
};

type ProjectSlug = keyof typeof projectDetails;

// ปรับ type ให้ถูกต้องตาม Next.js 15
export default async function ProjectDetail({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params; // Unwrap params ด้วย await
  ...
  return (
    <section className="section min-h-screen">
      ...
      <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
        ...
        <p>
          <strong>Frameworks & Tools:</strong> {project.frameworks}
        </p>
        <p>
